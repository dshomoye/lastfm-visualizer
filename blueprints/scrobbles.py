...
def get_scrobbles(lf_username):
    ...
    try:
        ...
        track_scrobbles = {
            "start": f"{start}",
            "end": f"{end}",
            "scrobbles": db.get_scrobbles_in_period(start_period=start, end_period=end),
        }
...
def get_listening_frequency(lf_username):
    try:
        ...
        frequency = {
            "start": str(start),
            "end": str(end),
            "frequency": db.get_track_count_in_period(
                start_period=start, end_period=end, unit=scale
            ),
        }
